...
class StatisticalJournalEntry extends RequestAbstract
{
    ...
    * @return string json:statisticalJournalEntryCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/statisticalJournalEntry";
    ...
    * 
    * @param $body {statisticalJournalEntry}
    ...
    */
    ...
    {
        $path = "/statisticalJournalEntry/$id";
        $args = $this->_argsToHttpParams(
            [
                'Prefer' => $prefer,
            ]
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:statisticalJournalEntry - Retrived record.
    * @response [default] nsError - Error response.
    */
