...
class VendorCategory extends RequestAbstract
{
   /**
    * GET /vendorCategory
    * 
    ...
    * @return string json:vendorCategoryCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:vendorCategory - Retrived record.
    * @response [default] nsError - Error response.
    */
