...
class AmortizationTemplate extends RequestAbstract
{
   /**
    ...
    * @return string json:amortizationTemplateCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/amortizationTemplate";
    ...
    * 
    * @param $body {amortizationTemplate}
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:amortizationTemplate - Retrived record.
    * @response [default] nsError - Error response.
    */
