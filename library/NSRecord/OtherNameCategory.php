...
class OtherNameCategory extends RequestAbstract
{
   /**
    ...
    * @return string json:otherNameCategoryCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/otherNameCategory";
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:otherNameCategory - Retrived record.
    * @response [default] nsError - Error response.
    */
