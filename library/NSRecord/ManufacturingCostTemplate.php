...
class ManufacturingCostTemplate extends RequestAbstract
{
    ...
    * @return string json:manufacturingCostTemplateCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/manufacturingCostTemplate";
    ...
    * 
    * @param $body {manufacturingCostTemplate}
    ...
    */
    ...
    {
        $path = "/manufacturingCostTemplate/$id";
        $args = $this->_argsToHttpParams(
            [
                'Prefer' => $prefer,
            ]
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:manufacturingCostTemplate - Retrived record.
    * @response [default] nsError - Error response.
    */
