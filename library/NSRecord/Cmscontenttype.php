...
class Cmscontenttype extends RequestAbstract
{
   /**
    * GET /cmscontenttype
    * 
    ...
    * @return string json:cmscontenttypeCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:cmscontenttype - Retrived record.
    * @response [default] nsError - Error response.
    */
