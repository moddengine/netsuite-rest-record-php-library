...
class BillingRevenueEvent extends RequestAbstract
{
   /**
    ...
    * @return string json:billingRevenueEventCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/billingRevenueEvent";
    ...
    * 
    * @param $body {billingRevenueEvent}
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:billingRevenueEvent - Retrived record.
    * @response [default] nsError - Error response.
    */
