...
class ConsolidatedExchangeRate extends RequestAbstract
{
   /**
    ...
    * @return string json:consolidatedExchangeRateCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/consolidatedExchangeRate";
    ...
    * 
    * @param $body {consolidatedExchangeRate}
    ...
    */
    ...
    {
        $path = "/consolidatedExchangeRate/$id";
        $args = $this->_argsToHttpParams(
            [
                'Prefer' => $prefer,
            ]
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:consolidatedExchangeRate - Retrived record.
    * @response [default] nsError - Error response.
    */
