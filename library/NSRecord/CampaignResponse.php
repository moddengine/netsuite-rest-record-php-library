...
class CampaignResponse extends RequestAbstract
{
   /**
    ...
    * @return string json:campaignResponseCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/campaignResponse";
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:campaignResponse - Retrived record.
    * @response [default] nsError - Error response.
    */
