...
class FulfillmentRequest extends RequestAbstract
{
   /**
    ...
    * @return string json:fulfillmentRequestCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/fulfillmentRequest";
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:fulfillmentRequest - Retrived record.
    * @response [default] nsError - Error response.
    */
