...
class RevenueCommitmentReversal extends RequestAbstract
{
   /**
    ...
    * @return string json:revenueCommitmentReversalCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/revenueCommitmentReversal";
    ...
    */
    ...
    {
        $path = "/revenueCommitmentReversal/$id";
        $args = $this->_argsToHttpParams(
            [
                'Prefer' => $prefer,
            ]
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:revenueCommitmentReversal - Retrived record.
    * @response [default] nsError - Error response.
    */
