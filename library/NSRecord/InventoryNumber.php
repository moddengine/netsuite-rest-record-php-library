...
class InventoryNumber extends RequestAbstract
{
   /**
    * GET /inventoryNumber
    * 
    ...
    * @return string json:inventoryNumberCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:inventoryNumber - Retrived record.
    * @response [default] nsError - Error response.
    */
