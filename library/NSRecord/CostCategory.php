...
class CostCategory extends RequestAbstract
{
   /**
    * GET /costCategory
    * 
    ...
    * @return string json:costCategoryCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:costCategory - Retrived record.
    * @response [default] nsError - Error response.
    */
