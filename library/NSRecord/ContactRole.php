...
class ContactRole extends RequestAbstract
{
   /**
    * GET /contactRole
    * 
    ...
    * @return string json:contactRoleCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:contactRole - Retrived record.
    * @response [default] nsError - Error response.
    */
