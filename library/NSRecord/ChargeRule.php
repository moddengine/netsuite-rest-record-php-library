...
class ChargeRule extends RequestAbstract
{
   /**
    * GET /chargeRule
    * 
    ...
    * @return string json:chargeRuleCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:chargeRule - Retrived record.
    * @response [default] nsError - Error response.
    */
