...
class ItemSupplyPlan extends RequestAbstract
{
   /**
    * GET /itemSupplyPlan
    * 
    ...
    * @return string json:itemSupplyPlanCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:itemSupplyPlan - Retrived record.
    * @response [default] nsError - Error response.
    */
