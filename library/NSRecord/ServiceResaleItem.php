...
class ServiceResaleItem extends RequestAbstract
{
   /**
    ...
    * @return string json:serviceResaleItemCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/serviceResaleItem";
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:serviceResaleItem - Retrived record.
    * @response [default] nsError - Error response.
    */
