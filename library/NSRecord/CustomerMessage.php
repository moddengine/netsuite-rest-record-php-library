...
class CustomerMessage extends RequestAbstract
{
    ...
    * @return string json:customerMessageCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:customerMessage - Retrived record.
    * @response [default] nsError - Error response.
    */
