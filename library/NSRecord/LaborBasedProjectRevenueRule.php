...
class LaborBasedProjectRevenueRule extends RequestAbstract
{
    ...
    * @return string json:laborBasedProjectRevenueRuleCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/laborBasedProjectRevenueRule";
    ...
    * 
    * @param $body {laborBasedProjectRevenueRule}
    ...
    */
    ...
    {
        $path = "/laborBasedProjectRevenueRule/$id";
        $args = $this->_argsToHttpParams(
            [
                'Prefer' => $prefer,
            ]
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:laborBasedProjectRevenueRule - Retrived record.
    * @response [default] nsError - Error response.
    */
