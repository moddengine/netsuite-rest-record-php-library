...
class SubscriptionTerm extends RequestAbstract
{
   /**
    ...
    * @return string json:subscriptionTermCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:subscriptionTerm - Retrived record.
    * @response [default] nsError - Error response.
    */
