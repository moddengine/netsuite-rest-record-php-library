...
class PayrollItem extends RequestAbstract
{
   /**
    * GET /payrollItem
    * 
    ...
    * @return string json:payrollItemCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:payrollItem - Retrived record.
    * @response [default] nsError - Error response.
    */
