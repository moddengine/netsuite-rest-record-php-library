...
class SalesOrder extends RequestAbstract
{
   /**
    * GET /salesOrder
    * 
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:salesOrder - Retrived record.
    * @response [default] nsError - Error response.
    */
    ...
    * @response [default] nsError - Error response.
    */
    public function transformToCashSale($body, $id = null, $replace = null, $prefer = null, $xNetSuitePropertyNameValidation = null, $xNetSuitePropertyValueValidation = null)
    {
    ...
    * @response [default] nsError - Error response.
    */
    public function transformToFulfillmentRequest($body, $id = null, $replace = null, $prefer = null, $xNetSuitePropertyNameValidation = null, $xNetSuitePropertyValueValidation = null)
    {
    ...
    * @response [default] nsError - Error response.
    */
    public function transformToInvoice($body, $id = null, $replace = null, $prefer = null, $xNetSuitePropertyNameValidation = null, $xNetSuitePropertyValueValidation = null)
    {
    ...
    * @response [default] nsError - Error response.
    */
    public function transformToItemFulfillment($body, $id = null, $replace = null, $prefer = null, $xNetSuitePropertyNameValidation = null, $xNetSuitePropertyValueValidation = null)
    {
    ...
    * @response [default] nsError - Error response.
    */
    public function transformToReturnAuthorization($body, $id = null, $replace = null, $prefer = null, $xNetSuitePropertyNameValidation = null, $xNetSuitePropertyValueValidation = null)
    {
    ...
    * @response [default] nsError - Error response.
    */
    public function transformToRevenueCommitment($body, $id = null, $replace = null, $prefer = null, $xNetSuitePropertyNameValidation = null, $xNetSuitePropertyValueValidation = null)
    {
    ...
    * @response [default] nsError - Error response.
    */
    public function transformToStorePickupFulfillment($body, $id = null, $replace = null, $prefer = null, $xNetSuitePropertyNameValidation = null, $xNetSuitePropertyValueValidation = null)
    {
