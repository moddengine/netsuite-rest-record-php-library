...
class OtherChargePurchaseItem extends RequestAbstract
{
   /**
    ...
    * @return string json:otherChargePurchaseItemCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/otherChargePurchaseItem";
    ...
    * 
    * @param $body {otherChargePurchaseItem}
    ...
    */
    ...
    {
        $path = "/otherChargePurchaseItem/$id";
        $args = $this->_argsToHttpParams(
            [
                'Prefer' => $prefer,
            ]
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:otherChargePurchaseItem - Retrived record.
    * @response [default] nsError - Error response.
    */
