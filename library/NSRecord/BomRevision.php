...
class BomRevision extends RequestAbstract
{
   /**
    * GET /bomRevision
    * 
    ...
    * @return string json:bomRevisionCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:bomRevision - Retrived record.
    * @response [default] nsError - Error response.
    */
