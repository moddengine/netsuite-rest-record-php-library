...
class AssemblyBuild extends RequestAbstract
{
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:assemblyBuild - Retrived record.
    * @response [default] nsError - Error response.
    */
    ...
    * @response [default] nsError - Error response.
    */
    public function transformToAssemblyUnbuild($body, $id = null, $replace = null, $prefer = null, $xNetSuitePropertyNameValidation = null, $xNetSuitePropertyValueValidation = null)
    {
