...
class OtherChargeSaleItem extends RequestAbstract
{
   /**
    ...
    * @return string json:otherChargeSaleItemCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/otherChargeSaleItem";
    ...
    * 
    * @param $body {otherChargeSaleItem}
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:otherChargeSaleItem - Retrived record.
    * @response [default] nsError - Error response.
    */
