...
class ItemDemandPlan extends RequestAbstract
{
   /**
    * GET /itemDemandPlan
    * 
    ...
    * @return string json:itemDemandPlanCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:itemDemandPlan - Retrived record.
    * @response [default] nsError - Error response.
    */
