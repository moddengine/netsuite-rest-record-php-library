...
class BillingClass extends RequestAbstract
{
   /**
    * GET /billingClass
    * 
    ...
    * @return string json:billingClassCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:billingClass - Retrived record.
    * @response [default] nsError - Error response.
    */
