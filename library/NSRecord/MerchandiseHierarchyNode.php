...
class MerchandiseHierarchyNode extends RequestAbstract
{
   /**
    ...
    * @return string json:merchandiseHierarchyNodeCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/merchandiseHierarchyNode";
    ...
    * 
    * @param $body {merchandiseHierarchyNode}
    ...
    */
    ...
    {
        $path = "/merchandiseHierarchyNode/$id";
        $args = $this->_argsToHttpParams(
            [
                'Prefer' => $prefer,
            ]
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:merchandiseHierarchyNode - Retrived record.
    * @response [default] nsError - Error response.
    */
