...
class CommerceCategory extends RequestAbstract
{
   /**
    ...
    * @return string json:commerceCategoryCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:commerceCategory - Retrived record.
    * @response [default] nsError - Error response.
    */
