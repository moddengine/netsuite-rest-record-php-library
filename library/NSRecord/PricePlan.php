...
class PricePlan extends RequestAbstract
{
   /**
    * GET /pricePlan
    * 
    ...
    * @return string json:pricePlanCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:pricePlan - Retrived record.
    * @response [default] nsError - Error response.
    */
