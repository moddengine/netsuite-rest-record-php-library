...
class ResourceAllocation extends RequestAbstract
{
    ...
    * @return string json:resourceAllocationCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:resourceAllocation - Retrived record.
    * @response [default] nsError - Error response.
    */
