...
class GenericResource extends RequestAbstract
{
   /**
    * GET /genericResource
    * 
    ...
    * @return string json:genericResourceCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:genericResource - Retrived record.
    * @response [default] nsError - Error response.
    */
