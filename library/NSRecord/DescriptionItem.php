...
class DescriptionItem extends RequestAbstract
{
   /**
    * GET /descriptionItem
    * 
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:descriptionItem - Retrived record.
    * @response [default] nsError - Error response.
    */
