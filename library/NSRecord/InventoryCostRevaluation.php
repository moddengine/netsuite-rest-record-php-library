...
class InventoryCostRevaluation extends RequestAbstract
{
   /**
    ...
    * @return string json:inventoryCostRevaluationCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/inventoryCostRevaluation";
    ...
    * 
    * @param $body {inventoryCostRevaluation}
    ...
    */
    ...
    {
        $path = "/inventoryCostRevaluation/$id";
        $args = $this->_argsToHttpParams(
            [
                'Prefer' => $prefer,
            ]
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:inventoryCostRevaluation - Retrived record.
    * @response [default] nsError - Error response.
    */
