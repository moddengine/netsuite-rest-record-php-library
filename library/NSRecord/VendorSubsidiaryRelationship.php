...
class VendorSubsidiaryRelationship extends RequestAbstract
{
   /**
    ...
    * @return string json:vendorSubsidiaryRelationshipCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/vendorSubsidiaryRelationship";
    ...
    * 
    * @param $body {vendorSubsidiaryRelationship}
    ...
    */
    ...
    {
        $path = "/vendorSubsidiaryRelationship/$id";
        $args = $this->_argsToHttpParams(
            [
                'Prefer' => $prefer,
            ]
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:vendorSubsidiaryRelationship - Retrived record.
    * @response [default] nsError - Error response.
    */
