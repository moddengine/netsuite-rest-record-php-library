...
class ItemAccountMapping extends RequestAbstract
{
    ...
    * @return string json:itemAccountMappingCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/itemAccountMapping";
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:itemAccountMapping - Retrived record.
    * @response [default] nsError - Error response.
    */
