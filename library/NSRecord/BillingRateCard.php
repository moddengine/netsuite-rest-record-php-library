...
class BillingRateCard extends RequestAbstract
{
    ...
    * @return string json:billingRateCardCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:billingRateCard - Retrived record.
    * @response [default] nsError - Error response.
    */
