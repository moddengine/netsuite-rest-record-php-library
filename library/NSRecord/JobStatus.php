...
class JobStatus extends RequestAbstract
{
   /**
    * GET /jobStatus
    * 
    ...
    * @return string json:jobStatusCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:jobStatus - Retrived record.
    * @response [default] nsError - Error response.
    */
