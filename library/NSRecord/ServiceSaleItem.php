...
class ServiceSaleItem extends RequestAbstract
{
   /**
    * GET /serviceSaleItem
    * 
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:serviceSaleItem - Retrived record.
    * @response [default] nsError - Error response.
    */
