...
class IntercompanyJournalEntry extends RequestAbstract
{
   /**
    ...
    * @return string json:intercompanyJournalEntryCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/intercompanyJournalEntry";
    ...
    * 
    * @param $body {intercompanyJournalEntry}
    ...
    */
    ...
    {
        $path = "/intercompanyJournalEntry/$id";
        $args = $this->_argsToHttpParams(
            [
                'Prefer' => $prefer,
            ]
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:intercompanyJournalEntry - Retrived record.
    * @response [default] nsError - Error response.
    */
