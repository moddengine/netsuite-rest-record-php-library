...
class PlanningRuleGroup extends RequestAbstract
{
    ...
    * @return string json:planningRuleGroupCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/planningRuleGroup";
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:planningRuleGroup - Retrived record.
    * @response [default] nsError - Error response.
    */
