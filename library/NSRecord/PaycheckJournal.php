...
class PaycheckJournal extends RequestAbstract
{
   /**
    * GET /paycheckJournal
    * 
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:paycheckJournal - Retrived record.
    * @response [default] nsError - Error response.
    */
