...
class BulkOwnershipTransfer extends RequestAbstract
{
   /**
    * POST /bulkOwnershipTransfer
    * 
    * @param $body {bulkOwnershipTransfer}
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:bulkOwnershipTransfer - Retrived record.
    * @response [default] nsError - Error response.
    */
