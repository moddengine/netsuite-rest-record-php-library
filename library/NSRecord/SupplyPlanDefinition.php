...
class SupplyPlanDefinition extends RequestAbstract
{
    ...
    * @return string json:supplyPlanDefinitionCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/supplyPlanDefinition";
    ...
    * 
    * @param $body {supplyPlanDefinition}
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:supplyPlanDefinition - Retrived record.
    * @response [default] nsError - Error response.
    */
