...
class FairValuePrice extends RequestAbstract
{
   /**
    * GET /fairValuePrice
    * 
    ...
    * @return string json:fairValuePriceCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:fairValuePrice - Retrived record.
    * @response [default] nsError - Error response.
    */
