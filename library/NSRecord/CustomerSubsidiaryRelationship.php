...
class CustomerSubsidiaryRelationship extends RequestAbstract
{
   /**
    ...
    * @return string json:customerSubsidiaryRelationshipCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/customerSubsidiaryRelationship";
    ...
    * 
    * @param $body {customerSubsidiaryRelationship}
    ...
    */
    ...
    {
        $path = "/customerSubsidiaryRelationship/$id";
        $args = $this->_argsToHttpParams(
            [
                'Prefer' => $prefer,
            ]
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:customerSubsidiaryRelationship - Retrived record.
    * @response [default] nsError - Error response.
    */
