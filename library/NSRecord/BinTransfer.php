...
class BinTransfer extends RequestAbstract
{
   /**
    * GET /binTransfer
    * 
    ...
    * @return string json:binTransferCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:binTransfer - Retrived record.
    * @response [default] nsError - Error response.
    */
