...
class SupplyChainSnapshot extends RequestAbstract
{
   /**
    ...
    * @return string json:supplyChainSnapshotCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/supplyChainSnapshot";
    ...
    * 
    * @param $body {supplyChainSnapshot}
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:supplyChainSnapshot - Retrived record.
    * @response [default] nsError - Error response.
    */
