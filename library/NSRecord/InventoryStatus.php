...
class InventoryStatus extends RequestAbstract
{
   /**
    * GET /inventoryStatus
    * 
    ...
    * @return string json:inventoryStatusCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:inventoryStatus - Retrived record.
    * @response [default] nsError - Error response.
    */
