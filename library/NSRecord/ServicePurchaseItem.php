...
class ServicePurchaseItem extends RequestAbstract
{
   /**
    ...
    * @return string json:servicePurchaseItemCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/servicePurchaseItem";
    ...
    * 
    * @param $body {servicePurchaseItem}
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:servicePurchaseItem - Retrived record.
    * @response [default] nsError - Error response.
    */
