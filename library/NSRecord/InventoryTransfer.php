...
class InventoryTransfer extends RequestAbstract
{
    ...
    * @return string json:inventoryTransferCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:inventoryTransfer - Retrived record.
    * @response [default] nsError - Error response.
    */
