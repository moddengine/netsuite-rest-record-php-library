...
class ReturnAuthorization extends RequestAbstract
{
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:returnAuthorization - Retrived record.
    * @response [default] nsError - Error response.
    */
    ...
    * @response [default] nsError - Error response.
    */
    public function transformToCashRefund($body, $id = null, $replace = null, $prefer = null, $xNetSuitePropertyNameValidation = null, $xNetSuitePropertyValueValidation = null)
    {
    ...
    * @response [default] nsError - Error response.
    */
    public function transformToCreditMemo($body, $id = null, $replace = null, $prefer = null, $xNetSuitePropertyNameValidation = null, $xNetSuitePropertyValueValidation = null)
    {
    ...
    * @response [default] nsError - Error response.
    */
    public function transformToRevenueCommitmentReversal($body, $id = null, $replace = null, $prefer = null, $xNetSuitePropertyNameValidation = null, $xNetSuitePropertyValueValidation = null)
    {
