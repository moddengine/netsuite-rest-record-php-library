...
class DiscountItem extends RequestAbstract
{
   /**
    * GET /discountItem
    * 
    ...
    * @return string json:discountItemCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:discountItem - Retrived record.
    * @response [default] nsError - Error response.
    */
