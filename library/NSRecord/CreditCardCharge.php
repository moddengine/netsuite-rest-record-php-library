...
class CreditCardCharge extends RequestAbstract
{
    ...
    * @return string json:creditCardChargeCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/creditCardCharge";
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:creditCardCharge - Retrived record.
    * @response [default] nsError - Error response.
    */
