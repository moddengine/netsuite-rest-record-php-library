...
class ItemGroup extends RequestAbstract
{
   /**
    * GET /itemGroup
    * 
    ...
    * @return string json:itemGroupCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:itemGroup - Retrived record.
    * @response [default] nsError - Error response.
    */
