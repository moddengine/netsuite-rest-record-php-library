...
class MerchandiseHierarchyLevel extends RequestAbstract
{
   /**
    ...
    * @return string json:merchandiseHierarchyLevelCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/merchandiseHierarchyLevel";
    ...
    * 
    * @param $body {merchandiseHierarchyLevel}
    ...
    */
    ...
    {
        $path = "/merchandiseHierarchyLevel/$id";
        $args = $this->_argsToHttpParams(
            [
                'Prefer' => $prefer,
            ]
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:merchandiseHierarchyLevel - Retrived record.
    * @response [default] nsError - Error response.
    */
