...
class PlanningItemGroup extends RequestAbstract
{
   /**
    ...
    * @return string json:planningItemGroupCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/planningItemGroup";
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:planningItemGroup - Retrived record.
    * @response [default] nsError - Error response.
    */
