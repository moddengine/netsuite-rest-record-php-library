...
class AccountingContext extends RequestAbstract
{
   /**
    ...
    * @return string json:accountingContextCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/accountingContext";
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:accountingContext - Retrived record.
    * @response [default] nsError - Error response.
    */
