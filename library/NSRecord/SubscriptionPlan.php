...
class SubscriptionPlan extends RequestAbstract
{
   /**
    ...
    * @return string json:subscriptionPlanCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:subscriptionPlan - Retrived record.
    * @response [default] nsError - Error response.
    */
