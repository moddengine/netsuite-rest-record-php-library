...
class UnitsType extends RequestAbstract
{
   /**
    * GET /unitsType
    * 
    ...
    * @return string json:unitsTypeCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:unitsType - Retrived record.
    * @response [default] nsError - Error response.
    */
