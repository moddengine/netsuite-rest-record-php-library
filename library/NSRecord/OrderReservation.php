...
class OrderReservation extends RequestAbstract
{
    ...
    * @return string json:orderReservationCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:orderReservation - Retrived record.
    * @response [default] nsError - Error response.
    */
