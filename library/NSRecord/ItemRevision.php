...
class ItemRevision extends RequestAbstract
{
   /**
    * GET /itemRevision
    * 
    ...
    * @return string json:itemRevisionCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:itemRevision - Retrived record.
    * @response [default] nsError - Error response.
    */
