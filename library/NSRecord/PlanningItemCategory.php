...
class PlanningItemCategory extends RequestAbstract
{
    ...
    * @return string json:planningItemCategoryCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/planningItemCategory";
    ...
    * 
    * @param $body {planningItemCategory}
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:planningItemCategory - Retrived record.
    * @response [default] nsError - Error response.
    */
