...
class SupplyChangeOrder extends RequestAbstract
{
   /**
    ...
    * @return string json:supplyChangeOrderCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/supplyChangeOrder";
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:supplyChangeOrder - Retrived record.
    * @response [default] nsError - Error response.
    */
