...
class BudgetExchangeRate extends RequestAbstract
{
   /**
    ...
    * @return string json:budgetExchangeRateCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/budgetExchangeRate";
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:budgetExchangeRate - Retrived record.
    * @response [default] nsError - Error response.
    */
