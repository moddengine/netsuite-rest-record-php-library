...
class SubtotalItem extends RequestAbstract
{
   /**
    * GET /subtotalItem
    * 
    ...
    * @return string json:subtotalItemCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:subtotalItem - Retrived record.
    * @response [default] nsError - Error response.
    */
