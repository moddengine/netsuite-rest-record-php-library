...
class SubscriptionLine extends RequestAbstract
{
   /**
    ...
    * @return string json:subscriptionLineCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/subscriptionLine";
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:subscriptionLine - Retrived record.
    * @response [default] nsError - Error response.
    */
