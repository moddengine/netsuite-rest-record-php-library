...
class Vendor extends RequestAbstract
{
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:vendor - Retrived record.
    * @response [default] nsError - Error response.
    */
    ...
    * @response [default] nsError - Error response.
    */
    public function transformToCustomer($body, $id = null, $replace = null, $prefer = null, $xNetSuitePropertyNameValidation = null, $xNetSuitePropertyValueValidation = null)
    {
    ...
    * @response [default] nsError - Error response.
    */
    public function transformToPurchaseOrder($body, $id = null, $replace = null, $prefer = null, $xNetSuitePropertyNameValidation = null, $xNetSuitePropertyValueValidation = null)
    {
    ...
    * @response [default] nsError - Error response.
    */
    public function transformToVendorBill($body, $id = null, $replace = null, $prefer = null, $xNetSuitePropertyNameValidation = null, $xNetSuitePropertyValueValidation = null)
    {
    ...
    * @response [default] nsError - Error response.
    */
    public function transformToVendorPayment($body, $id = null, $replace = null, $prefer = null, $xNetSuitePropertyNameValidation = null, $xNetSuitePropertyValueValidation = null)
    {
