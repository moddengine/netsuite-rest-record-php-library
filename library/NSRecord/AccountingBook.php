...
class AccountingBook extends RequestAbstract
{
    ...
    * @return string json:accountingBookCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:accountingBook - Retrived record.
    * @response [default] nsError - Error response.
    */
