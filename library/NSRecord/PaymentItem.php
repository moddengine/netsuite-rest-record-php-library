...
class PaymentItem extends RequestAbstract
{
   /**
    * GET /paymentItem
    * 
    ...
    * @return string json:paymentItemCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:paymentItem - Retrived record.
    * @response [default] nsError - Error response.
    */
