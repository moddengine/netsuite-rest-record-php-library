...
class IntercompanyTransferOrder extends RequestAbstract
{
   /**
    ...
    * @return string json:intercompanyTransferOrderCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/intercompanyTransferOrder";
    ...
    * 
    * @param $body {intercompanyTransferOrder}
    ...
    */
    ...
    {
        $path = "/intercompanyTransferOrder/$id";
        $args = $this->_argsToHttpParams(
            [
                'Prefer' => $prefer,
            ]
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:intercompanyTransferOrder - Retrived record.
    * @response [default] nsError - Error response.
    */
    ...
    */
    ...
    {
        $path = "/intercompanyTransferOrder/$id/!transform/itemFulfillment";
        $args = $this->_argsToHttpParams(
            [
                'Prefer' => $prefer,
                'X-NetSuite-PropertyNameValidation' => $xNetSuitePropertyNameValidation,
    ...
    * @response [default] nsError - Error response.
    */
    public function transformToItemReceipt($body, $id = null, $replace = null, $prefer = null, $xNetSuitePropertyNameValidation = null, $xNetSuitePropertyValueValidation = null)
    {
        $path = "/intercompanyTransferOrder/$id/!transform/itemReceipt";
        $args = $this->_argsToHttpParams(
            [
                'Prefer' => $prefer,
                'X-NetSuite-PropertyNameValidation' => $xNetSuitePropertyNameValidation,
