...
class CouponCode extends RequestAbstract
{
   /**
    * GET /couponCode
    * 
    ...
    * @return string json:couponCodeCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:couponCode - Retrived record.
    * @response [default] nsError - Error response.
    */
