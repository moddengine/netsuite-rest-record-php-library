...
class ContactCategory extends RequestAbstract
{
   /**
    * GET /contactCategory
    * 
    ...
    * @return string json:contactCategoryCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:contactCategory - Retrived record.
    * @response [default] nsError - Error response.
    */
