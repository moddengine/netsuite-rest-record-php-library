...
class OtherChargeResaleItem extends RequestAbstract
{
   /**
    ...
    * @return string json:otherChargeResaleItemCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/otherChargeResaleItem";
    ...
    * 
    * @param $body {otherChargeResaleItem}
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:otherChargeResaleItem - Retrived record.
    * @response [default] nsError - Error response.
    */
