...
class PeriodEndJournal extends RequestAbstract
{
    ...
    * @return string json:periodEndJournalCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/periodEndJournal";
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:periodEndJournal - Retrived record.
    * @response [default] nsError - Error response.
    */
