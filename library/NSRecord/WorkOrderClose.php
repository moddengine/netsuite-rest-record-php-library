...
class WorkOrderClose extends RequestAbstract
{
   /**
    * GET /workOrderClose
    * 
    ...
    * @return string json:workOrderCloseCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:workOrderClose - Retrived record.
    * @response [default] nsError - Error response.
    */
