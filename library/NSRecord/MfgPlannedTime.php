...
class MfgPlannedTime extends RequestAbstract
{
    ...
    * @return string json:mfgPlannedTimeCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:mfgPlannedTime - Retrived record.
    * @response [default] nsError - Error response.
    */
