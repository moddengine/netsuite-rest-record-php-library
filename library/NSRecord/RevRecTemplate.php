...
class RevRecTemplate extends RequestAbstract
{
   /**
    * GET /revRecTemplate
    * 
    ...
    * @return string json:revRecTemplateCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:revRecTemplate - Retrived record.
    * @response [default] nsError - Error response.
    */
