...
class PricingGroup extends RequestAbstract
{
   /**
    * GET /pricingGroup
    * 
    ...
    * @return string json:pricingGroupCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:pricingGroup - Retrived record.
    * @response [default] nsError - Error response.
    */
