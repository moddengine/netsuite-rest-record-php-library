...
class PhoneCall extends RequestAbstract
{
   /**
    * GET /phoneCall
    * 
    ...
    * @return string json:phoneCallCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:phoneCall - Retrived record.
    * @response [default] nsError - Error response.
    */
