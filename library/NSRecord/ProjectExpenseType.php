...
class ProjectExpenseType extends RequestAbstract
{
   /**
    ...
    * @return string json:projectExpenseTypeCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/projectExpenseType";
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:projectExpenseType - Retrived record.
    * @response [default] nsError - Error response.
    */
