...
class ReceiveInboundShipment extends RequestAbstract
{
   /**
    * POST /receiveInboundShipment
    * 
    * @param $body {receiveInboundShipment}
    ...
    */
    ...
    {
        $path = "/receiveInboundShipment/$id";
        $args = $this->_argsToHttpParams(
            [
                'Prefer' => $prefer,
            ]
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:receiveInboundShipment - Retrived record.
    * @response [default] nsError - Error response.
    */
