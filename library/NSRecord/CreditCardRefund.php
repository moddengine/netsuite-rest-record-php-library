...
class CreditCardRefund extends RequestAbstract
{
   /**
    ...
    * @return string json:creditCardRefundCollection - List of records.
    * @response [default] nsError - Error response.
    */
    public function getListOfRecords($q = null, $limit = null, $offset = null, $prefer = null)
    {
        $path = "/creditCardRefund";
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:creditCardRefund - Retrived record.
    * @response [default] nsError - Error response.
    */
