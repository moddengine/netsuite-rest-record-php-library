...
class ManufacturingRouting extends RequestAbstract
{
   /**
    ...
    * @return string json:manufacturingRoutingCollection - List of records.
    ...
    * 
    * @param $body {manufacturingRouting}
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:manufacturingRouting - Retrived record.
    * @response [default] nsError - Error response.
    */
