...
class InventoryCount extends RequestAbstract
{
   /**
    * GET /inventoryCount
    * 
    ...
    * @return string json:inventoryCountCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:inventoryCount - Retrived record.
    * @response [default] nsError - Error response.
    */
