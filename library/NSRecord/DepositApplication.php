...
class DepositApplication extends RequestAbstract
{
   /**
    ...
    * @return string json:depositApplicationCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:depositApplication - Retrived record.
    * @response [default] nsError - Error response.
    */
