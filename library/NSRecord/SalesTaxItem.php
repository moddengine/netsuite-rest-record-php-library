...
class SalesTaxItem extends RequestAbstract
{
   /**
    * GET /salesTaxItem
    * 
    ...
    * @return string json:salesTaxItemCollection - List of records.
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:salesTaxItem - Retrived record.
    * @response [default] nsError - Error response.
    */
