...
class InventoryAdjustment extends RequestAbstract
{
   /**
    ...
    * @return string json:inventoryAdjustmentCollection - List of records.
    ...
    * 
    * @param $body {inventoryAdjustment}
    ...
    * @param string $fields            
    * @param string enum(respond-async) $prefer
    * @return string json:inventoryAdjustment - Retrived record.
    * @response [default] nsError - Error response.
    */
